...
filename = 'diapason.wav'  # Cambia con il nome reale
...
# === 15. Applica un filtro in frequenza (es: passa-basso a 1000 Hz) ===

# Parametri del filtro
filter_type = "lowpass"   # Cambia con: "highpass" o "bandpass"
cutoff_low = 1000         # Frequenza di taglio bassa (per lowpass o bandpass)
cutoff_high = 3000        # Solo per passa-banda

# Calcolo FFT del segnale mono (se non l'hai già fatto)
...
# === 16. Salva il risultato del filtro ===
sf.write("audio_filtrato.wav", filtered_signal, samplerate)
print(f"✅ Filtro {filter_type} applicato. File salvato come 'audio_filtrato.wav'.")

# === 17. Sintetizzazione del segnale filtrato e salvataggio ===
