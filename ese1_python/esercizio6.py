#– Onda triangolare a 100 Hz, 200 Hz, 6000 Hz
#– Onda quadra a 100 Hz, 200 Hz, 6000 Hz
...
# Parametri di base
fs = 10000  # Frequenza di campionamento (12 kHz)
t = np.linspace(0, 1, fs)  # Vettore temporale da 0 a 1 secondo
frequenze = [100, 200, 6000]  # Frequenze per i segnali
